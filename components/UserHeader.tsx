...
const UserHeader: React.FC<UserHeaderProps> = ({ onOpenPricing }) => {
    const { user, userProfile, logout, loading, getRemainingCredits } = useAuth();
    ...
    const getSubscriptionBadge = () => {
        ...
        if (credits.type === 'points' && credits.count > 0) {
            return (
                    ...
                    <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-200 z-20 overflow-hidden">
                        ...
                        <div className="p-4 border-b bg-slate-50">
                            ...
                            <div className="mt-2 flex items-center gap-2">
                                {getSubscriptionBadge()}
                                {userProfile.points > 0 && credits.type !== 'points' && (
                                    <span className="bg-blue-100 text-blue-700 text-xs font-semibold px-2 py-1 rounded-full">
                        ...
                        <div className="py-2">
                            ...
                            >
                                ...
                                {credits.type === 'unlimited' ? '요금제 관리' : '요금제 / 충전'}
                            </button>
                            <button
                                onClick={async () => {
                                    await logout();
